...
void celt_fir_sse(const opus_val16 *_x,
         ...
         opus_val16 *mem)
{
   ...
   opus_int32 noA = (EXTEND32(1)<<(SIG_SHIFT)>>1);
   __m128i vecNoA = _mm_set_epi32(noA, noA, noA, noA);
   ...
   for (i=0;i<N-3;i+=4)
   {
      ...
      __m128i vecSum, vecX;
      vecSum = _mm_loadu_si128( (__m128i*)sum );
